...
/**
 * trustible theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { trustibleTheme } from './trustible';
 *   import './trustible.css';
 */
export const trustibleTheme = {
  name: 'trustible',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #22343d)",
    "--color-background-body": "light-dark(#f5f8fa, #17252c)",
    "--color-background-card": "light-dark(#ffffff, #1b1b1b)",
    "--color-background-popover": "light-dark(#ffffff, #1b1b1b)",
    "--color-background-muted": "light-dark(#edf3f4, #1d2c33)",
    "--color-accent": "light-dark(#344e5c, #b9d2da)",
    ...
    "--color-text-primary": "light-dark(#263b46, #f0f6f7)",
    "--color-text-secondary": "light-dark(#657b85, #b4c6cc)",
    ...
    "--color-background-green": "light-dark(#d8eee8, #204d45)",
    "--color-border-green": "light-dark(#b2d1ac, #69ad67)",
    "--color-icon-green": "light-dark(#2f7d6d, #85cfbd)",
